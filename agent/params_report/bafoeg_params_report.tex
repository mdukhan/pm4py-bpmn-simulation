...
\begin{itemize}
    \item \textbf{Zeitraum:} Die Simulation startet am \textbf{01.09.2024} und läuft über einen Zeitraum von \textbf{150 Tagen}, um das gesamte Wintersemester inklusive Nachlaufzeit abzubilden.
    \item \textbf{Reproduzierbarkeit:} Um konsistente Ergebnisse zu gewährleisten, wird ein fester \textbf{Random Seed (42)} verwendet.
...
Receive Parent Data & System & Normal & $\mu=10080$, $\sigma=3600$ & Wartezeit (Annahme: Normalverteilung) \\
...
Receive Missing Documents & System & Normal & $\mu=20160$, $\sigma=5760$ & Wartezeit (Annahme: Normalverteilung) \\
...
Zum Zeitpunkt des \glqq Application started\grqq{} werden technisch bereits alle potenziellen Dokumente (z.\,B. Formblatt 1, Immatrikulationsbescheinigung) instanziiert.
\begin{itemize}
    \item \textbf{Initialer Status:} Alle Dokumente starten im Status \texttt{Missing}.
    \item \textbf{Status-Wechsel:} Der Status ändert sich erst auf \texttt{Received}, wenn die entsprechende Aktivität (z.\,B. \glqq Receive Application\grqq{} oder \glqq Receive Parent Data\grqq{}) tatsächlich ausgeführt wird.
\end{itemize}
...
\begin{itemize}
  \item Anzahl: Inlandsförderung mit 32 Sachbearbeitern \cite{bewilligung2012} (SimPy Resource Capacity).
